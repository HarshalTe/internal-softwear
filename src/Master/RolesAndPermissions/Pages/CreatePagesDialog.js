...
const CreatePagesDialog = ({ open, handleClose }) => {
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      <DialogTitle>Add New Pages</DialogTitle>
      <DialogContent dividers>
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            <TextField fullWidth label="Deleted At" variant="outlined" type="date" size="small" InputLabelProps={{ shrink: true }} />
          </Grid>
        </Grid>
      </DialogContent>
      <DialogActions>
...
export default CreatePagesDialog;
