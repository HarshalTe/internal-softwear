...
import CreateFollowUpsDialog from "./CreateFollowUpsDialog";
...
const FollowUps = () => {
  ...
  const columns = [
    ...
    { field: "discussion", headerName: "Discussion", flex: 1 },
    { field: "next_follow_up_date", headerName: "Next Follow Up Date", flex: 1 },
    { field: "pending_from", headerName: "Pending Form", flex: 1 },
  ...
  return (
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {/* Popup Component */}
      <CreateFollowUpsDialog open={open} handleClose={handleClose} />
    </Box>
  );
};
