...
import CreateProposalsDialog from "./CreateProposalsDialog";
...
const Proposals = () => {
  ...
  const columns = [
    ...
    { field: "quotation_amount", headerName: "Quoation Amount", flex: 1 },
  ...
  return (
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {/* Popup Component */}
      <CreateProposalsDialog open={open} handleClose={handleClose} />
    </Box>
  );
};
