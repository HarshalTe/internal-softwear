...
// import CreatePaymentsDialog from "./CreateExpensesDialog";
...
const Expenses = () => {
  ...
  const columns = [
    ...
    { field: "expense_type_id", headerName: "Expense Type Id", flex: 1 },
    { field: "vendor_id", headerName: "Vendor Id", flex: 1 },
    { field: "user_id", headerName: "User Id", flex: 1 },
    { field: "name", headerName: "Name", flex: 1 },
    { field: "amount", headerName: "Amount", flex: 1 },
    { field: "is_approved", headerName: "Is Approved", flex: 1 },
  ...
  return (
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {/* Popup Component */}
       <CreateExpensesDialog open={open} handleClose={handleClose} /> 
    </Box>
  );
};
