...
// import CreateAmcTimelienesDialog from "./CreateAmcTimelienesDialog";
import CreateAmcTimelienesDialog from "./CreateAmcTimelinesDialog";
...
const AmcTimelienes = () => {
  ...
  const columns = [
    { field: "amc_id", headerName: "Amc Id", flex: 1 },
    { field: "amc_task_id", headerName: "Amc Task Id", flex: 1 },
  ...
  return (
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {/* Popup Component */}
       <CreateAmcTimelienesDialog open={open} handleClose={handleClose} />
    </Box>
  );
};

export default AmcTimelienes;
