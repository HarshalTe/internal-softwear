...
import CreateRatingsDialog from "./CreateRatingsDialog";
...
const Ratings = () => {
  ...
  const columns = [
    ...
    { field: "rater_id", headerName: "Rater Id", flex: 1 },
    { field: "point_type", headerName: "Point Type", flex: 1 },
    { field: "point_value", headerName: "Point Value", flex: 1 },
    { field: "point_value", headerName: "Point Value", flex: 1 },
    { field: "reason", headerName: "Point Value", flex: 1 },
  ...
  return (
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {/* Popup Component */}
      <CreateRatingsDialog open={open} handleClose={handleClose} />
    </Box>
  );
};
