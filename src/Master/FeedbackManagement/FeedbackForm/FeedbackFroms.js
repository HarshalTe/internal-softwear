...
import CreateFeedbackFromsDialog from "./CreateFeedbackFromsDialog";
...
const FeedbackFroms = () => {
  ...
  return (
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {/* Popup Component */}
      <CreateFeedbackFromsDialog open={open} handleClose={handleClose} />
    </Box>
  );
};

export default FeedbackFroms;
