...
import CreateAddOnServicesDialog from "./CreateAddOnServicesDialog";
...
const AddOnServices = () => {
  ...
  const columns = [
    ...
    { field: "fees", headerName: "Fees", flex: 1.5 },
  ...
  return (
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {/* Popup Component */}
      <CreateAddOnServicesDialog open={open} handleClose={handleClose} />
    </Box>
  );
};
