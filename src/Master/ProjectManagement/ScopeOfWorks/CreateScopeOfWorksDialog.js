...
const CreateScopeOfWorksDialog = ({ open, handleClose }) => {
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      ...
      <DialogContent dividers>
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
               <TextField fullWidth label="Due Date" variant="outlined" type="Date" size="small" InputLabelProps={{ shrink: true }} />
          </Grid>
        </Grid>
      </DialogContent>
      <DialogActions>
...
export default CreateScopeOfWorksDialog;
