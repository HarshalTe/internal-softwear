...
import CreateTaskLogsDialog from "../Tasks/CreateTaskDialog";
...
const TaskLogs = () => {
  ...
  const columns = [
    ...
    { field: "amc_task_id", headerName: "AMC Task Id", flex: 1.5 },
    ...
    { field: "is_amc_task", headerName: "Is Amc Task", flex: 1 },
    {
      field: "action",
      headerName: "Action",
      flex: 1,
  ...
  return (
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {/* Popup Component */}
      <CreateTaskLogsDialog open={open} handleClose={handleClose} />
    </Box>
  );
};
