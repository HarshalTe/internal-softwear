...
const CreateNotificationsDialog = ({ open, handleClose }) => {
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      ...
      <DialogContent dividers>
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            <TextField fullWidth label="Time" variant="outlined" type="time" size="small" InputLabelProps={{ shrink: true }} />
          </Grid>
          <Grid item xs={6}>
            <TextField fullWidth label="Priority" variant="outlined" size="small" />
          </Grid>
          <Grid item xs={6}>
            <TextField fullWidth label="Is Seen" variant="outlined" size="small" />
          </Grid>
          <Grid item xs={6}>
