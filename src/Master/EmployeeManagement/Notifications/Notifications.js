...
import CreateNotificationsDialog from "./CreateNotificationsDialog";
...
const Notifications = () => {
  ...
  const columns = [
    ...
    { field: "type", headerName: "Time", flex: 1.5 },
    { field: "priority", headerName: "Priority", flex: 1 },
    { field: "is_seen", headerName: "Is Seen", flex: 1 },
  ...
  return (
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {/* Popup Component */}
      <CreateNotificationsDialog open={open} handleClose={handleClose} />
    </Box>
  );
};
