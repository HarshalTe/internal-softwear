...
import CreateComplaintsDialog from "./CreateComplaintsDialog"
...
const Complaints = () => {
  ...
  const columns = [
    ...
    { field: "priority", headerName: "Priority", flex: 1.5 },
  ...
  return (
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {/* Popup Component */}
      <CreateComplaintsDialog open={open} handleClose={handleClose} />
    </Box>
  );
};
