...
const CreateIssuesDialog = ({ open, handleClose }) => {
  return (
    <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
      <DialogTitle>Add New Issues</DialogTitle>
      <DialogContent dividers>
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            <TextField fullWidth label="Technology" variant="outlined" size="small" />
          </Grid>
          <Grid item xs={6}>
            <TextField fullWidth label="Soluation" variant="outlined" size="small" />
          </Grid>
          <Grid item xs={6}>
            <TextField fullWidth label="Code" variant="outlined" size="small" />
          </Grid>
          <Grid item xs={6}>
            <TextField fullWidth label="references" variant="outlined" size="small" />
          </Grid>
          <Grid item xs={6}>
...
export default CreateIssuesDialog;
