...
import CreateIssuesDialog from "./CreateIssuesDialog";
...
const Issues = () => {
  ...
  const columns = [
    ...
    { field: "solutions", headerName: "Soluation", flex: 1.5 },
    { field: "code", headerName: "Code", flex: 1 },
    { field: "references", headerName: "References", flex: 1 },
  ...
  return (
    <Box sx={{ height: "100vh", display: "flex", flexDirection: "column", overflow: "hidden" }}>
      ...
      {/* Popup Component */}
      <CreateIssuesDialog open={open} handleClose={handleClose} />
    </Box>
  );
};
